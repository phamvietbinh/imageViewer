...
package com.mrkaz.imageviewer.viewer.adapter

import android.content.Context
import android.view.View
import android.view.ViewGroup
import com.github.chrisbanes.photoview.PhotoView
import com.mrkaz.imageviewer.common.pager.RecyclingPagerAdapter
...
internal class ImagesPagerAdapter<T>(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DefaultViewHolder<T> {
        ...
        return viewHolderLoader.loadViewHolder(photoView, imageLoader).also {
